...
messageSchema.pre("save",async function (next){
   ...
   */
  this.content=await bcryptjs.hash(this.content,10);
  next();


})
messageSchema.methods.encryptMessage = async function(content){
  return await bcryptjs.compare(content,this.content)
