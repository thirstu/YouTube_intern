...
import { deleteVideo,getAllVideos,getVideoById,publishAVideo,togglePublishStatus,updateVideo,getUsersAllVideos } from '../controllers/video.controller.js';
...
router.route("/all-users-videos?").get(getUsersAllVideos);
